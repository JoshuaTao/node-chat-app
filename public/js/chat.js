...
socket.on("roomData", (message) => {
  const html = Mustache.render(sidebarTemplate, message);
...
$sendLoactionButton.addEventListener("click", () => {
  if (!navigator.geolocation) {
    return alert("Sorry,your browser doesn't support geolocation sharing!");
  }

  $sendLoactionButton.setAttribute("disabled", true);
